/*
 * ============================================================================
 * MCL Paper 1 ND-Specific Extras — Bifurcation, Pesin, Complexity Measures
 * MCL (Madeeh Chaotic Lock) — Cryptographic Reference Implementation
 * ============================================================================
 *
 * Document ID:   MCL-PAPER1-EXTRAS-2026-0526-001
 * Version:       6.0.0
 ...
 * ============================================================================
 *
 * PURPOSE: Generate the supplementary dynamical-systems and complexity-theoretic
 * data required by reviewers of Paper 1 (Safe Zone PRNG) when submitting to
 * Nonlinear Dynamics (Springer). Provides bifurcation, mode-locking,
 * phase-space coverage, Pesin identity, permutation entropy, Sample entropy,
 * 0-1 test, RQA, extended autocorrelation, and p-value KS test.
 *
 * BUILD & RUN (one line, from this file's directory):
 *   g++ -O3 -std=c++17 -Wall -Wextra -Wpedantic -Wshadow -Wconversion -DMCL_UNSAFE_ALLOW_INVALID -o mcl_paper1_extras mcl_paper1_extras.cpp -lm && ./mcl_paper1_extras
 *
 * EXPECTED RESULTS: All 12 supplementary experiments PASS within tolerance. Exit 0.
 *
 * ============================================================================
 *
...
// VERSION / DOC IDS
// ============================================================================
static constexpr const char* DOC_ID      = "MCL-PAPER1-EXTRAS-2026-0526-001";
...
static void print_help(const char* prog) {
    ...
    std::printf("MCL Paper-1 Nonlinear-Dynamics extras v%s.\n", DOC_VERSION);
    std::printf("Generates supplementary dynamical-systems and complexity\n");
    std::printf("evidence (bifurcation, Pesin's identity, PE/SampEn/ApEn,\n");
    std::printf("0-1 test, full RQA, p-value distribution) for Paper 1.\n\n");
    std::printf("OPTIONS:\n");
    std::printf("  --full       Canonical run (~8 sec on Apple M2 Max, default).\n");
...
int main(int argc, char** argv) {
    ...
    std::printf("\n==============================================================================\n");
    std::printf("  MCL PAPER-1 ND EXTRAS v%s\n", DOC_VERSION);
    std::printf("  %s\n", DOC_ID);
